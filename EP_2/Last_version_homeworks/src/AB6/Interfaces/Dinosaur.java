...
public interface Dinosaur {
     ...
     * @return the unique DNA of type {@code DinosaurDNA} of the dinosaur.
     */
    DinosaurDNA getDNA();
    ...
    /**
     * Enum representing the biological sex of a dinosaur.
     */
    enum Sex {
        MALE,
        FEMALE
    ...
    /**
     * Returns the sex of the dinosaur, which can be either male or female.
     *
     * @return the biological sex of the dinosaur.
     */
    Sex getBiologicalSex();

    /**
     * Returns the dinosaur's combat behavior.
     *
     * @return an instance of the {@code FightingBehavior} interface representing the dinosaur's behavior in combat.
     */
    FightingBehavior getFightingBehavior();
